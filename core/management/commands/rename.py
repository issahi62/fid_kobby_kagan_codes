...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        files_to_rename = ['fidsap_web/settings/base.py', 'fidsap_web/wsgi.py', 'manage.py']
        folder_to_rename = 'fidsap_web'

        for f in files_to_rename:
            with open(f, 'r') as file:
                filedata = file.read()

            filedata = filedata.replace('fidsap_web', new_project_name)
